      ...
      <article class="balance">
        ...
        <div class="label">
          <label class="label__text" for="wallet">
            <span class="label__span">*</span> Amount</label
          >
          <BaseInput id="wallet" label="$0.0" type="number"/>
          <p class="sp text-start">Amount to transfer example: $0.00</p>
        </div>
        <div class="label">
          <label class="label__text" for="walletDestination">
            <span class="label__span">*</span> Destination wallet</label
          >
          <BaseInput id="walletDestination" label="Wallet"/>
        </div>
        <article class="newWallet__container__balance__contain__actions">
          <BaseButton label="Cancel" class="transparent"></BaseButton>
          <BaseButton
